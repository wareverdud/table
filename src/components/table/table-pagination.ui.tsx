...
export const TablePagination = ({page, setOptions, last_visible_page}: IPaginationProps) => (
    <div className="pagination">
        ...
        <select onChange={(event) => setOptions((prevState) => ({...prevState, limit: Number(event.target.value)}))}>
